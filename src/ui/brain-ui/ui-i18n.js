...
const EN = new Map(Object.entries({
  ...
  '媒體服務僅使用本機、OpenAI 相容或 Google Gemini；請在 GAI Control Center 管理。': 'Media services use only local, OpenAI-compatible, or Google Gemini providers. Manage them in GAI Control Center.',
  'OpenStreetMap 无需 Key；Google Maps Key 可在 Google Cloud 頁面建立。': 'OpenStreetMap needs no key. Create a Google Maps key on the Google Cloud page.',
  ...
  '人物卡片': 'Person card', '等待选择人物': 'Waiting for a person', '当你不认识某位公众人物时，GAI AI 会在这里弹出一张简短人物卡片。': 'When you do not recognize a public figure, GAI AI shows a short person card here.',
