---
name: Agent Skills
description: Explain, inspect, create, and maintain GAI AI Agent Skills packages built around SKILL.md instructions.
tags:
  - skills
  - agent
  - workflow
...
Use this skill when the user asks about GAI AI skills, wants to list installed skills, or wants to create a reusable workflow package.

## GAI AI Skill Format

A GAI AI Agent Skill is a folder under the configured skills root. The required file is `SKILL.md`.
...
- Keep `description` specific. GAI AI uses it during skill selection.
